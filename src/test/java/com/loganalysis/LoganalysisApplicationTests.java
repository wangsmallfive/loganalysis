...
class LoganalysisApplicationTests {
    ...
    public static void main(String[] args) {
        System.out.println(randomDate("2020-03-01","2020-03-07"));
    }
    ...
    public static String outLog() {
        ...
        //随机生成时间
        Date date = randomDate("2020-03-01","2020-03-07");
        //随机生成视频名称
        ...
        //随机生成用户ID
        getStringRandom(10);
        returnString =randomIp+" - - "+"["+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(date)+"]"
                + " "+"\""+" "+name[0]+""+" "+name[1]+""+" "+random.nextInt(101)+""
